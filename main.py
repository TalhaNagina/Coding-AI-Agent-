...
the working directory. So, ypu should typically start by looking at
the project's files, and figuring out on how to run the project and how 
...
"""
    ...
    for i in range(0, max_iter):
        ...
        if response.function_calls:
            ...
            # Only print if there is a text response
            if response.text:
                print(response.text)
            break
