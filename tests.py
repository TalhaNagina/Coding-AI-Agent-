...
def main():
    ...
    #print(get_files_content(working_dir, "pkg/calculator.py"))
    #print(get_files_content(working_dir, "main.py"))
    #print(get_files_content(working_dir, "/bin/cat"))
    #print(get_files_content(working_dir, "pkg/random.py"))
