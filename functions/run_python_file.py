...
STDERR:{output.stderr}
        ...
        if output.stdout == "" and output.stderr == "":
            final_string += "Process completed with no output.\n"
...
schema_run_python_file = types.FunctionDeclaration(
    ...
    description="Runs a python file with the python3 interpreter.Accepts the additional CLI args as an optional array.",
